...
const ReferralsW = () => {
  ...
  return (
    <div className="bg-main-color h-screen w-screen flex items-center text-center justify-center">
      <div className="bg-main-color2 flex flex-col justify-center align-items-center rounded-t-[3rem] w-full h-5/6 shadow-20xl-inner">
        ...
        <button className="flex justify-center border-2 w-full md:w-80 border-yellow-400 mx-10 p-4 align-middle mt-[1rem] bg-green-500/20 rounded-3xl" onClick={copyToClipboard}>
